...
# Load the first model to get the base attributes
with open(model_files[0], 'rb') as f:
    base_esn = pickle.load(f)

# Initialize combined attributes
...
# Average the weights (optional - comment out if you want to sum instead)
...
# Create a new EnhancedESN with the combined attributes
...
# Also combine vectorizers if they exist
...
# Combine tokenizers if they exist
...
if tokenizer_files:
    ...
    # Load the first tokenizer to get base attributes
